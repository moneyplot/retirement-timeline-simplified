...
\begin{itemize}
    ...
    \item $s$: Annual Savings during working years (\$)
    \item $c$: Annual Consumption during retirement years(\$)
...
w = \frac{c \cdot H}{s + c}
\end{equation}
In the example in Figure 1, $c = \$50,000\text{/year}$, $s = \$10,000\text{/year}$, \\
