    ...
    \begin{equation}
    \text{Peak Assets} = A_0 + c \cdot w
    \end{equation}
    
    Upon entering retirement, the accumulation engine shuts off and the depletion engine takes over. The capital depletion loop draws down our peak nest egg by a flat budget spending block $b$ each year for the remaining $f$ retirement years ($H - w$) until landing exactly on our target legacy floor $L$:
    \begin{equation}
    \text{Peak Assets Required} = L + b \cdot (H - w)
    \end{equation}
